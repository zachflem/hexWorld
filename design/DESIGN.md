...
- **Per-level structure sprites** — most structures still share one map icon across upgrade levels; walls/paths already vary by tier. Planned as ROADMAP [#P11](ROADMAP.md#per-level-structure-sprites-p11).
